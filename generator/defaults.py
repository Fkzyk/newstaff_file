...
def jobkan_announce_date(nyusha_date):
    """事前案内メールを送る日(自動送信日の1週間前、土日は前倒し)。"""
    return _prev_weekday(jobkan_auto_date(nyusha_date) - dt.timedelta(days=7))


JOBKAN_MAIL1_SUBJECT = "【株式会社資さん】入社書類のご申請について（ジョブカンワークフロー）"
JOBKAN_MAIL1_BODY = """※※※【送信前チェック ※送信前にこの5行を削除してください】※※※
①送信日: {事前案内送信日}ごろ(=ジョブカン自動送信日の1週間前)
②本文中の登録メール送信日「{ジョブカン送信日}」が正しいか確認
③添付「入社時のワークフロー申請について」が付いているか確認
④BCC({BCC人数}名・自動設定済み)が{入社日}入社の新入社員全員か確認
※※※※※※※※※※※※※※※※※※※※※※※※※※※※
...
{ジョブカン送信日}に、皆様から伺っているメールアドレス宛へジョブカンの登録メールをお送りします。メールが届きましたら、添付資料の案内に沿って申請書類のご登録をお願いいたします。
...
JOBKAN_MAIL2_BODY = """※※※【送信前チェック ※送信前にこの5行を削除してください】※※※
①送信日: {ジョブカン送信日}(=ジョブカンの自動送信日当日)
②本文の「本日{ジョブカン送信日}」が本日の日付と合っているか確認
③添付「入社時のワークフロー申請について」が付いているか確認
④BCC({BCC人数}名・自動設定済み)が{入社日}入社の新入社員全員か確認
※※※※※※※※※※※※※※※※※※※※※※※※※※※※
...
本日{ジョブカン送信日}に、皆様のメールアドレス宛へジョブカンの登録メールを送信いたしました。
