...
for i, t in enumerate([
  ...
  "6. 競合の公開求人にも最低賃金割れの旧掲載が多数ありました。いずれも自動判定で「未確定」に落としています。",
  "7. 同一店舗に複数の異なる金額が見つかったもの（ケンタッキー イオンタウン黒崎店、マクドナルド イオン戸畑SC店、",
  "   ケンタッキー 鳥栖店）は、どちらかを自動で選ばず「未確定(情報源の矛盾)」にしています。",
