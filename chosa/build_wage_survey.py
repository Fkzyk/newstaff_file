...
RECORDS = [
    ...
    R("宮崎阿波岐原店", "自社(参考)", "資さんうどん 宮崎阿波岐原店の公開求人", "宮崎県宮崎市阿波岐原町請田2420",
      "12099", 1000,
      "平日1,000円～／土日祝1,130円～／深夜 平日1,250円・土日祝1,413円", "店舗固有求人",
      "https://sukesan-job.net/jobfind-pc/job/All/12099",
      "★社内データの現行1,050円と食い違う。掲載値1,000円は宮崎県最低賃金1,023円を下回る旧掲載。主表は社内データを正とする"),
...
notes = [
    "1. 7店舗中6店舗（陣山・新池・宗像・菊陽・鳥栖真木・佐賀兵庫）の時給は、県の地域別最低賃金と1円単位で同額です。差は0円です。",
    "2. 宮崎阿波岐原店だけが最低賃金より27円高い1,050円で、7店舗の中で唯一の例外です。",
    "3. 深夜時給は全店とも 基本時給×1.25 の切り上げで、社内データ内の整合は取れています。",
    "4. 全7店舗が周辺相場の中央値を下回っています。差は陣山の-13円から鳥栖真木の-170円までで、",
    "   北九州（陣山・新池）は僅差、佐賀・熊本（鳥栖真木・佐賀兵庫・菊陽）で開きが大きくなっています。",
    "5. 宮崎阿波岐原店の公開求人は平日1,000円のままで、社内データの1,050円と食い違います。",
    "   1,000円は宮崎県の最低賃金1,023円を下回るため、2025年11月の改定前の旧掲載です。求人票の更新が必要と思われます。",
    "6. 公開求人には最低賃金割れの旧掲載が複数ありました（丸亀製麺 鳥栖店980円・佐賀店1,000円・宮崎住吉店1,000円、",
    "   うどんウエスト 菊陽光の森店900円、および上記の自社求人1,000円）。いずれも自動判定で「未確定」に落としています。",
    "7. 周辺相場は公開求人の掲載値であり、実際に支払われている時給ではありません。証明レベルの違いは調査台帳を参照してください。",
]
